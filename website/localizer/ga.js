function L(s, gloss){
  ...
  if(s=="trigger_domainAdd") return "ceanglaíodh réimse le hiontráil";
  if(s=="trigger_domainRemove") return "dícheanglaíodh réimse d'iontráil";
  ...
  if(s=="trigger_desigAdd") return "cuireadh téarma le hiontráil";
  if(s=="trigger_desigRemove") return "baineadh téarma d'iontráil";
  ...
  if(s=="trigger_termAnnotReorder") return "athraíodh ord na noda sa téarma";
  if(s=="trigger_termAnnotPositionChange") return "athraíodh suíomh an noda sa téarma";
  ...
  if(s=="trigger_definitionAdd") return "cuireadh sainmhíniú le hiontráil";
  if(s=="trigger_definitionRemove") return "baineadh sainmhíniú d'iontráil";
  ...
  if(s=="trigger_exampleAdd") return "cuireadh sampla úsáide le hiontráil";
  if(s=="trigger_exampleRemove") return "baineadh sampla úsáide d'iontráil";
  ...
  if(s=="trigger_exampleTextReorder") return "athraíodh ord na n-abairtí sa sampla úsáide";
  if(s=="trigger_exampleTextChange") return "athraíodh foclaíocht abairte sa sampla úsáide";
  if(s=="trigger_collectionAdd") return "ceanglaíodh bailiúchán le hiontráil";
  if(s=="trigger_collectionRemove") return "dícheanglaíodh bailiúchán d'iontráil";
  if(s=="trigger_collectionReorder") return "athraíodh ord na mbailiúchán san iontráil";
  if(s=="trigger_collectionChange") return "athraíodh cén bailiúchán atá ceangailte le hiontráil";
  if(s=="trigger_extranetAdd") return "ceanglaíodh eislíon le hiontráil";
  if(s=="trigger_extranetRemove") return "dícheanglaíodh eislíon d'iontráil";
  if(s=="trigger_extranetReorder") return "athraíodh ord na n-eislíon san iontráil";
  if(s=="trigger_extranetChange") return "athraíodh cén r-eislíon atá ceangailte leis an iontráil";
  ...
  if(s=="trigger_sourceReorder") return "athraíodh ord na bhfoinsí faoi rud iontráil";
