Screenful.Navigator={
  start: function(){
    ...
    $("#starlist > .inside > .title").append("<div class='menuContainer'><span class='clickable'>"+Screenful.Loc.actions+" <span class='arrow'>▼</span></span><div class='menu' style='display: none'></div></div>");
