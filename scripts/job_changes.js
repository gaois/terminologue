var FROM="2021-10-01"; //on or after this date
var TILL="2021-11-01"; //before this date
const WRITE_TO="2021-11-01_entrylist.txt";
...
const db = new Database('bnt-2021-11-04_1514.sqlite', { fileMustExist: true });
