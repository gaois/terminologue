var FROM="2021-11-01"; //on or after this date
var TILL="2021-12-01"; //before this date
const WRITE_TO="2021-12-01_entrylist.txt";
...
const db = new Database('bnt-2021-12-07_1836.sqlite', { fileMustExist: true });
