...
const BNT_EXTRANET_ID="4626831"; //an eislíon in BNT (Terminologue) air ar cheart na hiontrálacha a chur, mar shampla "Liosta IATE na Bealtaine"
...
const HISTORY_EMAIL="valselob@gmail.com";
...
var lineReader=require('readline').createInterface({
  input: require('fs').createReadStream('./fiat.txt')
});
