...
const TBXImport=require("./tbx-import.js");
...
ipcRenderer.on("message-to-worker", (event, obj) => {
  if(obj.task=="tbx-import"){
    if(obj.message=="want-start") TBXImport.start(obj.input, obj.output, messageToUI);
    if(obj.message=="want-abort") TBXImport.abort();
  }
